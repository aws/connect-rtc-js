...
describe('signalingTest', () => {
    ...
    describe('SignalingState', () => {
        ...
        it('calls timeout handler if it\'s current state', () => {
            ...
            chai.assert((signalingState.onTimeout as sinon.SinonStub).called, 'onTimeout should have been called');
        });
        ...
        it('skips calling timeout handler if it\'s not current state', () => {
            ...
            signalingState.onTimeout = sinon.spy();
            signalingState._onTimeoutChecked();
            chai.assert(!(signalingState.onTimeout as sinon.SinonStub).called, 'onTimeout should have not been called');
        });
    ...
    describe('FailOnTimeoutState', () => {
        ...
        it('transit to Failed state with Timeout exception', (done) => {
            signaling.transit = (nextState: SignalingState) => {
    ...
    describe('PendingAnswerState', () => {
         ...
         */
        var state: PendingAnswerState;

        beforeEach(() => {
            signaling = {};
            state = new PendingAnswerState(signaling, 9, 0);
        });
        ...
        it('notifies and goes to pending accept state upon receiving success response', (done) => {
            ...
            signaling._answeredHandler = (sdp: string, candidates: string[]) => {
    ...
    describe('PendingAcceptState', () => {
         ...
         */
        var state: PendingAcceptState;

        beforeEach(() => {
            signaling = {};
            state = new PendingAcceptState(signaling, true, 0);
        });
    ...
    describe('PendingConnectContactState', () => {
         ...
         * @type {PendingAcceptState}
         */
        var state: PendingConnectContactState;
    ...
    describe('PendingAcceptAckState', () => {
         ...
         */
        var state: PendingAcceptAckState;
    ...
    describe('TalkingState', () => {
        ...
        beforeEach(() => {
            ...
            state = new TalkingState(signaling, '', 0, '');
        });
        ...
        it('moves to FailedState when receives an error response for accept/connectContact request', () => {
            ...
            state = new TalkingState(signaling, methodId, 0, '');
            signaling.transit = sinon.spy();
            state.onRpcMsg({
                jsonrpc: '2.0',
                error: {
    ...
    describe('IdleState', () => {
        ...
        beforeEach(() => {
            ...
            state = new IdleState(signaling, '', 0, '');
        });
        ...
        it('moves to FailedState when receives an error response for accept/connectContact request', () => {
            const methodId = 'example-id'
            state = new IdleState(signaling, methodId, 0, '');
            signaling.transit = sinon.spy();
            state.onRpcMsg({
                jsonrpc: '2.0',
                error: {
    ...
    describe('PendingReconnectState', () => {
         ...
         */
        var state: PendingReconnectState;

        beforeEach(() => {
            signaling = {};
            state = new PendingReconnectState(signaling);
        });
    ...
    describe('PendingRemoteHangupState', () => {
         ...
         */
        var state: PendingRemoteHangupState;
    ...
    describe('PendingLocalHangupState', () => {
         ...
         */
        var state: PendingLocalHangupState;
