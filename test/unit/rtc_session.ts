...
import { RTCSessionState, GrabLocalMediaState, CreateOfferState, SetLocalSessionDescriptionState, ConnectSignalingAndIceCollectionState, InviteAnswerState, AcceptState, TalkingState, CleanUpState, DisconnectedState, FailedState } from '../../src/rtc_session';
import { RTC_ERRORS } from '../../src/rtc_const';
import { BusyException, CallNotFoundException } from '../../src/exceptions';
...
describe('RTC session', () => {
    describe('session object', () => {
        ...
        var strategy: CCPInitiationStrategyInterface;
        var session: any;
        ...
        beforeEach(() => {
            ...
            session = new RtcSession('wss://amazon-connect-rtc-server.amazonaws.com/', [], 'contactToken', console, null, null, null, strategy);
        });
        ...
        describe('buildMediaContraints', () => {
            ...
            it('should build media constraints with window override', () => {
                (global.window as any).audio_input = 'device-id-123';
    ...
    describe('GrabLocalMediaState', () => {
        ...
        it('notifies gum error and go to failed state if gUM times out', (done) => {
            ...
            state._gUM = sinon.stub().returns(new Promise(() => { }));
            state.onEnter();
            done();
        });
        ...
        it('notifies gum error and go to failed state if gUM fast fails', (done) => {
            ...
            state._gUM = sinon.stub().returns(Promise.reject('testFailure'));
            state.onEnter();
        });
        ...
        it('notifies gum success and go to create offer state if gUM succeeds within time limit', (done) => {
            ...
            state._gUM = sinon.stub().returns(Promise.resolve({}));
            state.onEnter();
        });
    });
    ...
    describe('SetLocalSessionDescriptionState', () => {
         ...
         */
        var state: SetLocalSessionDescriptionState;
        ...
        it('transits to signaling state when local description is set', (done) => {
            ...
            session.transit = (nextState: RTCSessionState) => {
    ...
    describe('ConnectSignalingAndIceCollectionState', () => {
         ...
         */
        var state: ConnectSignalingAndIceCollectionState;
